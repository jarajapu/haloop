...
import org.apache.hadoop.examples.descendant.Descendant;
import org.apache.hadoop.examples.descendant.NaiveDescendant;
import org.apache.hadoop.examples.kmeans.KMeans;
import org.apache.hadoop.examples.kmeans.NaiveKMeans;
...
public class ExampleDriver {
	...
	public static void main(String argv[]) {
		...
		try {
			pgd.addClass("wcount", WCount.class,
					"A map/reduce program that counts words.");

			pgd.addClass("kmeans", KMeans.class, "k-means clustering");

			pgd
					.addClass("kmeansnaive", NaiveKMeans.class,
							"k-means clustering");

			pgd.addClass("descendent", Descendant.class,
					"A map/reduce program that does recursive queries.");

			pgd.addClass("pageranknew",
					org.apache.hadoop.examples.pagerank.PageRankNew.class,
					"Page Rank New Interface");

			pgd.addClass("pagerank",
					org.apache.hadoop.examples.pagerank.PageRankNew.class,
					"A map/reduce program that does page rank.");

			pgd.addClass("naivepagerank",
					org.apache.hadoop.examples.pagerank.NaivePageRank.class,
					"A map/reduce program that does page rank.");

			pgd.addClass("naivedescendent", NaiveDescendant.class,
					"A map/reduce program that does recursive queries.");
